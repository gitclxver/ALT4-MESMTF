    ...
    <>
      ...
      <div className="bg-slate-50 min-h-screen py-16">
        <div className="container mx-auto px-4">
              ...
              <ul className="space-y-4">
                <li className="p-4 bg-slate-50 rounded-lg border border-slate-200 flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Today at 11:00 AM</p>
                  </div>
                  <button className="bg-cyan-600 text-white text-sm font-semibold py-1 px-4 rounded-lg shadow-md hover:bg-cyan-700 transition-colors">
                    View
                  </button>
                </li>
                <li className="p-4 bg-slate-50 rounded-lg border border-slate-200 flex justify-between items-center">
          ...
          <section id="mypatients" className="mb-12">
            <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
              <h2 className="text-2xl font-bold text-slate-800 mb-4">
                My Patients
              </h2>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 text-center">
                <div className="p-6 bg-slate-50 rounded-lg border border-slate-200">
                  ...
                  <p className="mt-2 text-slate-600">Total Diagnoses</p>
                </div>
                <div className="p-6 bg-slate-50 rounded-lg border border-slate-200">
                  <p className="text-5xl font-bold text-cyan-600">98%</p>
                  <p className="mt-2 text-slate-600">Correct Diagnosis Rate</p>
                </div>
                <div className="p-6 bg-slate-50 rounded-lg border border-slate-200">
                  <p className="text-5xl font-bold text-cyan-600">12</p>
                  <p className="mt-2 text-slate-600">New Patients This Month</p>
                </div>
              </div>
            </div>
          </section>
